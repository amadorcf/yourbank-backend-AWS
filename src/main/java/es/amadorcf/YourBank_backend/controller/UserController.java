...
import es.amadorcf.YourBank_backend.dto.LoginRequest;
import es.amadorcf.YourBank_backend.dto.OtpRequest;
import es.amadorcf.YourBank_backend.dto.OtpVerificationRequest;
import es.amadorcf.YourBank_backend.dto.UserResponse;
import es.amadorcf.YourBank_backend.entity.User;
import es.amadorcf.YourBank_backend.security.JwtTokenUtil;
import es.amadorcf.YourBank_backend.service.OTPService;
import es.amadorcf.YourBank_backend.service.UserService;
...
public class UserController {
    ...
    public ResponseEntity<?> login(@RequestBody LoginRequest loginRequest) {
        ...
        String email = loginRequest.getAccountNumber();
        String finalAccountNumber = userService.getUserByEmail(email).getAccount().getAccountNumber();
        System.out.println(finalAccountNumber);
        ...
        try {
            ...
            authenticationManager.authenticate(
                    ...
                    new UsernamePasswordAuthenticationToken(finalAccountNumber, loginRequest.getPassword())
            );
        ...
        UserDetails userDetails = userDetailsService.loadUserByUsername(finalAccountNumber);
