...
import es.amadorcf.YourBank_backend.security.JwtAuthenticationEntryPoint;
import es.amadorcf.YourBank_backend.security.JwtAuthenticationFilter;
import es.amadorcf.YourBank_backend.service.JWTUserDetailsService;
		...
		http.csrf(AbstractHttpConfigurer::disable)
				...
				.authorizeHttpRequests(authorize -> authorize
						...
						.requestMatchers("/api/users/register", "/api/users/login",
								"/api/users/generate-otp", "/api/users/verify-otp").permitAll()
